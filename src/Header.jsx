...
export default function Header({profileImg}){
    ...
    return(
        <div className="yt-c-header_container">
            <div className='yt-c-header_wrapper'>
                <header className='yt-c-header' onClick = {closePopup}>
                    <div id='start'>
                        <button><FontAwesomeIcon id='icon' icon={faBars} alt='menu' onClick={()=>setNav(!nav)}/></button>
                    ...
                    <div id='center'>
                        <form>  
                            <div className="searchContainer" >
                                <span><FontAwesomeIcon id='icon' icon={faMagnifyingGlass}/></span>
